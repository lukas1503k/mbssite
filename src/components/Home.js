...
import stock from "../images/istockphoto-603823268-1024x1024.jpg"
    ...
    render() {
        return (
            ...
            <Heading/>
                ...
                <Row width = "100%" style ={{width:"99vw", marginTop: "7.08333vw"}}>
                ...
                <Row style ={{width:"99vw", paddingRight:"0px", marginTop:"12.8333333333vw"}}>
                    <Col xs="4" style = {{paddingLeft: "4vw"}}>
                        <img src={QRcode} style={{width:"30vw", height:"25vw"}}/>
                    </Col>
                    ...
                    <Col style = {{paddingRight:"0px"}}>
                            ...
                            <h2 style = {{fontSize:"1.3333vw", lineHeight:"2.253333vw"}} id="h1Subtext">
                ...
                <Row style={{width: "99vw", paddingRight: "0px", marginTop: "11.4116666vw"}}>
                    <Col style={{paddingRight: "0px"}}>
                        <div style={{marginLeft: "6vw", width: "56vw"}}>
                            <h1 style={{fontSize:"2.25vw"}}>
                                Health Data On the Fly!
                            </h1>

                            <h2 id="h1Subtext" style={{fontSize:"1.3333vw", marginTop:"2.8333vw"}}>
             ...
             <br/>
                ...
                <Row style={{
                    ...
                    <Col style={{marginLeft: "9vw", marginRight: "9vw"}}>
                        ...
                        <Row>
                            <h2 id="h1Subtext" style={{fontSize: "1.33333vw"}}>
                ...
                <Row style = {{marginTop:"14.6666vw"}}>
                    ...
                    <Col>
                        ...
                        <p id="h1Subtext" style={{fontSize: "1.25vw"}}>
